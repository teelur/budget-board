...
export const appUpdateQueryKey: string = "appUpdate";
...
export const recurringRulesQueryKey: string = "recurringRules";
export const recurringForecastQueryKey: string = "recurringForecast";
...
export const transactionLinkCandidatesQueryKey: string =
  "transactionLinkCandidates";
