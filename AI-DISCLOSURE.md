...
This project pre-dates the widespread availability of LLM-based AI tools, and thus a majority of the core architecture of the project was created without any AI assistance. Since early 2025, I have started using AI tools as part of my workflow, mostly due to some of the benefits I have found in my professional work.
...
My general philosophy is to treat AI tools as an overly eager intern/junior developer. They can provide interesting sugggestions and can be helpful with some hand-holding, but should not be trusted with high-stakes features.
...
The build infrastructure (CI/CD pipelines, Dockerfiles, etc.) was largely set up before AI tools were widely available, so they are mostly human-authored.
