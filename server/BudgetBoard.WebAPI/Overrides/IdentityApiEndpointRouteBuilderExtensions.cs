...
public static class IdentityApiEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointConventionBuilder MyMapIdentityApi<TUser>(
        ...
        where TUser : class, new()
    {
        ...
        if (!configureOptions.ExcludeRefreshPost)
        {
            routeGroup.MapPost(
                ...
                > ([FromBody] RefreshRequest refreshRequest, [FromServices] IServiceProvider sp) =>
                {
                    ...
                    var refreshTicket = refreshTokenProtector.Unprotect(
            ...
            routeGroup
                ...
                .Add(endpointBuilder =>
                {
                    ...
                    endpointBuilder.Metadata.Add(
                        new EndpointNameMetadata(confirmEmailEndpointName)
                    );
                });
        }
        ...
        if (!configureOptions.ExcludeManageGroup)
        {
            ...
            if (!configureOptions.Exclude2faGet)
            {
                accountGroup.MapGet(
                    "/2fa",
                    ...
                    ) =>
                    {
                        ...
                        return TypedResults.Ok(
                            new TwoFactorResponse
                            {
                                ...
                                IsTwoFactorEnabled = await userManager.GetTwoFactorEnabledAsync(
                                    user
                                ),
                                IsMachineRemembered =
