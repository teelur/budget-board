...
namespace BudgetBoard.Database.Migrations
{
    ...
    [Migration("20260323134905_AddToshlFullSyncProgress")]
    partial class AddToshlFullSyncProgress
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BudgetBoard.Database.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("ToshlAccessToken")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<DateTime>("ToshlLastSync")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("BudgetBoard.Database.Models.UserSettings", b =>
                {
                    ...
                    b.Property<int>("ToshlAutoSyncIntervalHours")
                        .HasColumnType("integer");

                    b.Property<string>("ToshlCategoryMappingsJson")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<DateTime?>("ToshlFullSyncCompletedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("ToshlFullSyncError")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("ToshlFullSyncProgressDescription")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("ToshlFullSyncProgressPercent")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("ToshlFullSyncQueuedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("ToshlFullSyncStartedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("ToshlFullSyncStatus")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("ToshlMetadataSyncDirection")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("ToshlSyncLookbackMonths")
                        .HasColumnType("integer");
