...
public static partial class LocalizationHelpers
{
    ...
    /// with any non-alphanumeric separator character(s). Ensures MM, DD, and YYYY each appear exactly once.
    /// </summary>
    ...
    public static bool IsValidDateFormat(string dateFormat)
    {
        ...
        // Match pattern: (MM|DD|YYYY) + non-alphanumeric separator + (MM|DD|YYYY) + separator + (MM|DD|YYYY)
